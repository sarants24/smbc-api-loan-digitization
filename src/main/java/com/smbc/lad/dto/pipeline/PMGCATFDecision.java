...
public class PMGCATFDecision {
	...
	private String projectedRarora;
	private String projectedRofa;
	private String projectedGrossProfit;
	private String deadlineCommitmentSummary;
	private String catfSummaryChairId;
	private String catfSummaryChairDescription;
	private String catfMeetingtypeId;
	private String catfMeetingtypeDescription;
	private String catfChairId;
	private String catfChairDescription;
	private String catfDate;
	private String catfApprovalStatusId;
	private String catfApprovalStatusDescription;
	private String catfDecisionId;
	private String catfDecisionDescription;
	private String catfRational;
	private String pmgDate;
	private String pmgCatfSupportEscalate;
	private String pmgDecisionId;
	private String pmgDecisionDescription;
	...
	private String ancillaryTimePeriodId;
	private String ancillaryTimePeriodDescription;
	...
	private String ancillaryRaroraTimePeriodId;
	private String ancillaryRaroraTimePeriodDescription;
	...
	public String getProjectedRarora() {
		return projectedRarora;
	}
	public void setProjectedRarora(String projectedRarora) {
		this.projectedRarora = projectedRarora;
	}
	...
	public String getDeadlineCommitmentSummary() {
		return deadlineCommitmentSummary;
	}
	public void setDeadlineCommitmentSummary(String deadlineCommitmentSummary) {
	...
	public String getCatfSummaryChairDescription() {
		return catfSummaryChairDescription;
	}
	public void setCatfSummaryChairDescription(String catfSummaryChairDescription) {
		this.catfSummaryChairDescription = catfSummaryChairDescription;
	}
	...
	public String getCatfMeetingtypeDescription() {
		return catfMeetingtypeDescription;
	}
	public void setCatfMeetingtypeDescription(String catfMeetingtypeDescription) {
		this.catfMeetingtypeDescription = catfMeetingtypeDescription;
	}
	public String getCatfChairId() {
		return catfChairId;
	}
	public void setCatfChairId(String catfChairId) {
		this.catfChairId = catfChairId;
	}
	public String getCatfChairDescription() {
		return catfChairDescription;
	}
	public void setCatfChairDescription(String catfChairDescription) {
		this.catfChairDescription = catfChairDescription;
	}
	public String getCatfDate() {
		return catfDate;
	}
	public void setCatfDate(String catfDate) {
	...
	public String getCatfApprovalStatusDescription() {
		return catfApprovalStatusDescription;
	}
	public void setCatfApprovalStatusDescription(String catfApprovalStatusDescription) {
		this.catfApprovalStatusDescription = catfApprovalStatusDescription;
	}
	...
	public String getCatfDecisionDescription() {
		return catfDecisionDescription;
	}
	public void setCatfDecisionDescription(String catfDecisionDescription) {
		this.catfDecisionDescription = catfDecisionDescription;
	}
	...
	public String getPmgDate() {
		return pmgDate;
	}
	public void setPmgDate(String pmgDate) {
	...
	public String getPmgDecisionDescription() {
		return pmgDecisionDescription;
	}
	public void setPmgDecisionDescription(String pmgDecisionDescription) {
		this.pmgDecisionDescription = pmgDecisionDescription;
	}
	...
	public String getConditionDeadline() {
		return conditionDeadline;
	}
	public void setConditionDeadline(String conditionDeadline) {
		this.conditionDeadline = conditionDeadline;
	}
	public String getAncillaryTimePeriodId() {
		return ancillaryTimePeriodId;
	}
	public void setAncillaryTimePeriodId(String ancillaryTimePeriodId) {
		this.ancillaryTimePeriodId = ancillaryTimePeriodId;
	}
	public String getAncillaryTimePeriodDescription() {
		return ancillaryTimePeriodDescription;
	}
	public void setAncillaryTimePeriodDescription(String ancillaryTimePeriodDescription) {
		this.ancillaryTimePeriodDescription = ancillaryTimePeriodDescription;
	}
	...
	public String getAncillaryRaroraTimePeriodId() {
		return ancillaryRaroraTimePeriodId;
	}
	public void setAncillaryRaroraTimePeriodId(String ancillaryRaroraTimePeriodId) {
		this.ancillaryRaroraTimePeriodId = ancillaryRaroraTimePeriodId;
	}
	public String getAncillaryRaroraTimePeriodDescription() {
		return ancillaryRaroraTimePeriodDescription;
	}
	public void setAncillaryRaroraTimePeriodDescription(String ancillaryRaroraTimePeriodDescription) {
		this.ancillaryRaroraTimePeriodDescription = ancillaryRaroraTimePeriodDescription;
	}
