 ...
 * @since April 2022
 * 
 * Entity class to read/update data from/to table 'pipeline_analysis_peer_ltm_files'
 *
 */
@NoArgsConstructor
@AllArgsConstructor
...
@Data
@Entity
@Table(name = "pipeline_analysis_peer_ltm_files")
public class AnalysisPeerFilesLTMEntity {
