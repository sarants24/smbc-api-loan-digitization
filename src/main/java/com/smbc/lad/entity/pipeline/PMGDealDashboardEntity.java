...
//@SecondaryTable(name = "")
public class PMGDealDashboardEntity {
	...
	@OneToOne
	@JoinColumn(name = "id", referencedColumnName="pipelineId",insertable = false,updatable = false)
	private PipelineDealsBasicsEntity pipelineDealsBasicsEntity;
	
	@OneToOne
	@JoinColumn(name = "id", referencedColumnName="pipelineId",insertable = false,updatable = false)
	private PipelineDealsCreditEntity pipelineDealsCreditEntity;
		
	@OneToOne
	@JoinColumn(name = "id", referencedColumnName="pipelineId",insertable = false,updatable = false)
	private DealWorkflowEntity dealWorkflowEntity;
	...
	public DealWorkflowEntity getDealWorkflowEntity() {
		return dealWorkflowEntity;
	}

	public void setDealWorkflowEntity(DealWorkflowEntity dealWorkflowEntity) {
		this.dealWorkflowEntity = dealWorkflowEntity;
	}

	public PipelineDealsBasicsEntity getPipelineDealsBasicsEntity() {
		return pipelineDealsBasicsEntity;
	}

	public void setPipelineDealsBasicsEntity(PipelineDealsBasicsEntity pipelineDealsBasicsEntity) {
		this.pipelineDealsBasicsEntity = pipelineDealsBasicsEntity;
	}

	public PipelineDealsCreditEntity getPipelineDealsCreditEntity() {
		return pipelineDealsCreditEntity;
	}

	public void setPipelineDealsCreditEntity(PipelineDealsCreditEntity pipelineDealsCreditEntity) {
		this.pipelineDealsCreditEntity = pipelineDealsCreditEntity;
	}
