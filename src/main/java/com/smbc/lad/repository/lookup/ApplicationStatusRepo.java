 ...
 */
@Repository
public interface ApplicationStatusRepo extends 
								JpaRepository<ApplicationStatusEntity, String> {

	public List<ApplicationStatusEntity> findAllByOrderByOrderSequenceAsc();
